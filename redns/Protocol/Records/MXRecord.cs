...
namespace redns.Protocol.Records
{
        ...
        : Record<MXInfo>
    {
        ...
        public MXRecord (Zone zone, string name, RecordClass @class, UInt32 ttl)
            : base (zone, name, @class, RecordType.MX, ttl)
        {
        ...
        {
            yield return new MXResourceRecord { Data = this.Data };
        }
    }
}
